...
<?php
    ...
    $sql = "update musician_board set subject='$subject', content='$content' "; // 수정된 제목과 내용을 UPDATE 쿼리로 작성
    ...
    echo "
	      <script>
	          location.href = 'musician_board_list.php?page=$page'; // 목록 페이지로 이동하는 자바스크립트 코드
	      </script>
	  ";
?>
