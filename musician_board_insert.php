...
<?php
	...
	$regist_day = date("Y-m-d (H:i)");  // 현재 시간을 '년-월-일-시-분' 형식으로 저장
	...
	$sql = "insert into musician_board (id, name, subject, content, regist_day, hit,  file_name, file_type, file_copied) ";
	...
	echo "
	   <script>
	    location.href = 'musician_board_list.php';  // 게시판 목록 페이지로 이동
	   </script>ㅈ
	";  // 자바스크립트를 통한 페이지 이동
?>
