<!-- 공연공지 게시판의 아무 곳에서 '목록'버튼을 클릭하면 실행되는 페이지-->
<!-- DB에 저장되어 있는 공연공지 게시판의 게시글을 모두 보여주는 페이지 -->
...
<section>
    ...
    <div id="board_box">
        ...
        <ul id="board_list">
            ...
            $sql = "select * from notice_board order by num desc";  // 최신 글 순으로 정렬하여 뮤지션 게시판의 글 가져오기
        ...
        <ul id="page_num">     
            ...
            if ($total_page>=2 && $page >= 2) {
                $new_page = $page-1;
                echo "<li><a href='notice_board_list.php?page=$new_page'>◀ 이전</a> </li>";  // 이전 페이지 링크
            } else {
                echo "<li>&nbsp;</li>";
            }
            ...
            if ($total_page>=2 && $page != $total_page) {
                $new_page = $page+1;  
                echo "<li> <a href='notice_board_list.php?page=$new_page'>다음 ▶</a> </li>";  // 다음 페이지 링크
            } else {
                echo "<li>&nbsp;</li>";
            }
            ?>
        ...
        <ul class="buttons">
            ...
            <li><button onclick="location.href='notice_board_list.php'">목록</button></li>  <!-- 목록 버튼 -->
            <li>
                <?php 
                if($userid) {
                ?>
                <button onclick="location.href='notice_board_form.php'">글쓰기</button>  <!-- 로그인 상태에서 글쓰기 버튼 -->
                <?php
                } else {
                ?>
